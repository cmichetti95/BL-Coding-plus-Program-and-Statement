...
public abstract class ProgramTest {
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseSameInstructionError() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseDifferentIdentifierError() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseBadIdentifierError() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseDifferentInstructionError() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParsePrimitiveInstructionError() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
