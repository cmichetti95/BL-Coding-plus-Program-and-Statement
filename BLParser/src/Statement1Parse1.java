...
public final class Statement1Parse1 extends Statement1 {
    ...
    private static void parseIf(Queue<String> tokens, Statement s) {
        ...
        Reporter.assertElseFatalError(Tokenizer.isCondition(condition),
                "Invalid syntax. Expected BL condition");
        ...
        ifBlock.transferFrom(s);

        //determine if or if else
        if (tokens.front().equals("ELSE")) {
            tokens.dequeue();
            Statement elseBlock = s.newInstance();
            s.parseBlock(tokens);
            elseBlock.transferFrom(s);
    ...
    private static void parseWhile(Queue<String> tokens, Statement s) {
        ...
        tokens.dequeue();
        String condS = tokens.dequeue();
        Reporter.assertElseFatalError(Tokenizer.isCondition(condS),
                "Invalid syntax. Expected BL condition");
        Condition condition = parseCondition(condS);
        Reporter.assertElseFatalError(tokens.dequeue().equals("DO"),
                "Invalid syntax. Expected DO");
        s.parseBlock(tokens);
        Reporter.assertElseFatalError(tokens.dequeue().equals("END"),
                "Invalid syntax. Expected END");
        Reporter.assertElseFatalError(tokens.dequeue().equals("WHILE"),
                "Invalid syntax. Expected WHILE");

        Statement whileBlock = s.newInstance();
        whileBlock.transferFrom(s);
